<!-- <nav class="navbar">
    ...
    <div class="logo"><a href="#">Attack On Titan Wiki</a></div>
    <ul class="menu-list">
...
<div class="justify-content-between mt-3">
    <div class="col-6 ms-3">
        ...
        <p>
        Attack on Titan has become a critical and commercial success. As of December 2019, the manga has over 100 million tankōbon copies in print worldwide, making it one of the best-selling manga series of all time. It has won several awards, including the Kodansha Manga Award, the Attilio Micheluzzi Award, and the Harvey Award.</p>
    </div>
