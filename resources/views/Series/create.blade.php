...
<div class="card">
    ...
    <div class="card-body">
        ...
        <x-adminlte-input type="url" name="cover" label="Cover:" placeholder="Please insert link" fgroup-class="col-md-6">
        </x-adminlte-input>
        </div>
        ...
        <div class="row">
        <x-adminlte-input type="url" name="trailer" label="Trailer:" placeholder="Please insert link" fgroup-class="col-md-6">
        </x-adminlte-input>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="col icheck-primary">
                    <input type="checkbox" id="someCheckboxId" name="genre[]" value="action"/>
                     <label for="someCheckboxId">Action</label>
                </div>
                <div class="col icheck-primary">
                    <input type="checkbox" id="someCheckboxId" name="genre[]" value="dark-fantasy"/>
                     <label for="someCheckboxId">Dark Fantasy</label>
                </div>
                <div class="col icheck-primary">
                    <input type="checkbox" id="someCheckboxId" name="genre[]" value="post-apocalyptic"/>
                     <label for="someCheckboxId">Post Apocalyptic</label>
                </div>
                <div class="col icheck-primary">
                    <input type="checkbox" id="someCheckboxId" name="genre[]" value="comedy" />
                     <label for="someCheckboxId">Comedy</label>
                </div>
                <div class="col icheck-primary">
                    <input type="checkbox" id="someCheckboxId" name="genre[]" value="romance" />
                     <label for="someCheckboxId">Romance</label>
                </div>
            </div>
        </div>
